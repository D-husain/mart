...
public class userController {
	...
	public String sendotp(@RequestParam("email") String email,@ModelAttribute("user") User user, HttpSession session,RedirectAttributes redirAttrs) {
		...
		String message = ""
				...
				+ "                                </td>"
				+ "                                <td style='display: block; text-align: center;'>"
				+ "                                    <h3 style='font-weight: 700; font-size: 20px; margin: 0;color: #939393;margin-top: 15px;'> Hi User,</h3>"
				+ "                                </td>"
				+ "                                <td style='display:block; text-align:center'>"
				+ "                                    <p style='font-size: 17px;font-weight: 600;width: 74%;margin: 8px auto 0;line-height: 1.5;color: #939393;'>We are sending you this email because you have requested a password reset. Use this otp to create new password:</p>"
				+ "                                </td>"
				+ "                            </tr>"
				+ "                        </thead>"
				+ "                    </table>"
				...
				+ "                            <tr style='display: block;'>"
				+ "                                <td style='display: block; text-align: center;'>"
				+ "                                    <button style='background-color:#0DA487; border:none; color:#fff; padding:14px 26px; font-size:18px; border-radius:6px; font-weight:600;'>"+ otp1 + otp2 +otp3 +otp4 +otp5 +otp6 +"</button>"
				+ "                                </td>"
				+ "                            </tr>"
				+ "                        </thead>"
				+ "                    </table>"
				...
				+ "                            <tr style='display: block;'>"
				+ "                                <td style='display: block; text-align: center;'>"
				+ "                                    <p style='font-size: 17px;font-weight: 600;width: 74%;margin: 8px auto 0;line-height: 1.5;color: #939393;'> If you didn’t request a password reset, you can ignore this email. your password will not be changed.</p>"
				+ "                                </td>"
				+ "                            </tr>"
				+ "                        </thead>"
				+ "                    </table>"
				...
				+ "                                    <tr>"
				+ "                                        <td>"
				+ "                                            <a href='http://localhost:8080/contact' style='font-size: 14px; font-weight: 600; color: #fff; text-decoration: underline; text-transform: capitalize;'>Contact Us</a>"
				+ "                                        </td>"
				+ "                                        <td>"
				...
				+ "                                        </td>"
				+ "                                        <td>"
				+ "                                            <a href='javascript:void(0)' style='font-size: 14px; font-weight: 600; color: #fff; text-decoration: underline; text-transform: capitalize; margin-left: 20px;'>privacy Policy</a>"
				+ "                                        </td>"
				+ "                                    </tr>"
				+ "                                </table>"
				...
				+ "                                    <tr>"
				+ "                                        <td>"
				+ "                                            <h5 style='font-size: 13px; text-transform: uppercase; margin: 0; color:#ddd; letter-spacing:1px; font-weight: 500; text-align: center;'>Want to change how you receive these emails?"
				+ "                                            </h5>"
				+ "                                            <h5 style='font-size: 13px; text-transform: uppercase; margin: 10px 0 0; color:#ddd; letter-spacing:1px; font-weight: 500; text-align: center;'> 2021-22 copy right by fastKart</h5>"
				+ "                                        </td>"
				+ "                                    </tr>"
				+ "                                </table>"
				+ "                            </td>"
